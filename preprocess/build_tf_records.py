...
def _process_image_files(name, file_names, labels, num_shards, num_threads):
    ...
    for i in range(len(spacing) - 1):
        ranges.append([spacing[i], spacing[i + 1]])  # images are divided into threads 6 currently parts
...
def _process_dataset(name, directory, num_shards, num_threads):
    ...
    Args:
      ...
      num_shards: integer number of shards for this data set. data shard:数据分片
    """
