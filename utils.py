Data_Prefix = '/Users/apple/Documents/PycharmProjects/official/data'
DATA_SET_NAME = 'data/train-data'
...
EXTRACTED_PATCHES_NEGATIVE_PATH = Data_Prefix + '/train-data/Extracted_Negative_Patches/'
EXTRACTED_PATCHES_POSITIVE_PATH = Data_Prefix + '/train-data/Extracted_Positive_Patches/'
...
PATCHES_TRAIN_DIR = Data_Prefix + '/train-data'
PREFIX_SHARD_VALIDATION = 'validation'
PATCHES_VALIDATION_DIR = Data_Prefix + '/Validation-data'
...
PATCH_INDEX_NEGATIVE = 000000
PATCH_INDEX_POSITIVE = 000000
